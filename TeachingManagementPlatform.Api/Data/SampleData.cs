        ...
        var profiles = new List<LecturerProfile>
        {
            new LecturerProfile
            {
                ...
                Experiences = new List<ProfileExperience>
                {
                    ...
                    new() { Description = "Giáo viên trung tâm Anh ngữ ABC (2016-2018)", SortOrder = 2 },
            ...
            new LecturerProfile
            {
                ...
                Experiences = new List<ProfileExperience>
                {
                    new() { Description = "Giáo viên tại trung tâm Anh ngữ Wall Street (2020-nay)", SortOrder = 1 },
            ...
            new LecturerProfile
            {
                ...
                Experiences = new List<ProfileExperience>
                {
                    ...
                    new() { Description = "Giáo viên trung tâm Khoa học ABC (2016-2018)", SortOrder = 2 },
            ...
            new LecturerProfile
            {
                ...
                Experiences = new List<ProfileExperience>
                {
                    new() { Description = "Giáo viên tại trung tâm ngoại ngữ Alliance Française (2019-nay)", SortOrder = 1 },
            ...
            new LecturerProfile
            {
                ...
                Experiences = new List<ProfileExperience>
                {
                    ...
                    new() { Description = "Giáo viên trung tâm Khoa học Tự nhiên (2018-2020)", SortOrder = 2 },
