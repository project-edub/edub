...
public interface IGoogleFormsService
{
    ...
    /// </summary>
    Task<(string FormId, string FormEditUrl, string DriveWebViewLink)> CreateFormAsync(string title, List<GeneratedQuizQuestion> questions, string? teacherEmail, string? googleAccessToken = null);
}
